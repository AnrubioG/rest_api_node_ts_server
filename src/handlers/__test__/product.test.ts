...
describe("POST /api/products", () => {
  it("should display validation errors", async () => {
    const respose = await request(server).post("/api/products").send({});

    expect(respose.status).toBe(400);
    expect(respose.body).toHaveProperty("errors");
    // expect(respose.body.errors).toHaveLength(4);

    expect(respose.status).not.toBe(404);
    // expect(respose.body.errors).not.toHaveLength(4);
  });
  ...
  it("should validate that the price is greater than 0", async () => {
    ...
    expect(respose.status).not.toBe(404);
    // expect(respose.body.errors).not.toHaveLength(2);
  });
  ...
  it("should validate that the price is a number and greater than 0", async () => {
    ...
    expect(respose.status).toBe(400);
    expect(respose.body).toHaveProperty("errors");
    // expect(respose.body.errors).toHaveLength(2);
...
describe("GET /api/products", () => {
  it("should check is api/product url exists", async () => {
